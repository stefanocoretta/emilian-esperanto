...
plot(ubm_cond_sp, facet_args = list(ncol = 4))[[1]] +
  labs(fill = "Comprehension\nlevel", colour =  "Comprehension\nlevel", x = "Dimension 1 (language attitudes)")


ggsave("img/compr-brm-sp.png", width = 7, height = 4)
```
...
plot(ubm_cond_dim, facet_args = list(ncol = 5))[[1]] +
  labs(fill = "Comprehension\nlevel", colour =  "Comprehension\nlevel", x = "Dimension 1 (language attitudes)")

ggsave("img/compr-brm-dim.png", width = 7, height = 4)
```
...
plot(sbm_cond_sp, facet_args = list(ncol = 4))[[1]] +
  labs(fill = "Speaking\nlevel", colour = "Speaking\nlevel", x = "Proportion of spaces")

ggsave("img/speak-brm-sp.png", width = 7, height = 4)
```
...
plot(sbm_cond_dim, facet_args = list(ncol = 5))[[1]] +
  labs(fill = "Speaking\nlevel",  colour = "Speaking\nlevel", x = "Dimension 1 (language attitudes)")

ggsave("img/speak-brm-dim.png", width = 7, height = 4)
```
...
```{r rw-bm-cond}
plot(conditional_effects(rw_bm, effects = "spaces_prop:dim_1"))[[1]] +
  labs(fill = "Read-write\nlevel", colour = "Read-write\nlevel", x = "Proportion of spaces")

ggsave("img/rw-brm-spaces.png", width = 7, height = 4)
