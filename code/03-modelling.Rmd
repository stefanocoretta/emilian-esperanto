...
understand_pchek <- brm(
  ...
  backend = "cmdstanr",
  cores = 4,
  file = "./data/cache/understand_pchek"
)
...
ubm_cond_sp <- conditional_effects(understand_bm, effects = "spaces_prop", categorical = TRUE, conditions = conditions)
...
ubm_cond_dim <- conditional_effects(understand_bm, effects = "dim_1", categorical = TRUE, conditions = conditions)
...
understand_bm_age <- brm(
  ...
  cores = 4,
  threads = threading(2),
  file = "./data/cache/understand_bm_age"
)
```

```{r understand-cond-age}
conditions <- expand.grid(
  language = c("Emilian", "Esperanto")
)
...
ubm_cond_age <- conditional_effects(understand_bm_age, effects = "age", categorical = TRUE, conditions = conditions)
...
understand_rur_bm <- brm(
  ...
  cores = 4,
  threads = threading(2),
  file = "./data/cache/understand_rur_bm"
)
